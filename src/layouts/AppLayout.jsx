...
export const AppLayout = () => {
  ...
  return (
    <div
      className={`min-h-screen flex flex-col md:flex-row transition-colors duration-250 ${
        isDark ? "bg-[#09090b] text-zinc-100" : "bg-[#F8F9FC] text-slate-800"
      }`}
    >
      {/* ===== SIDEBAR DESKTOP ===== */}
      <aside
        className={`hidden md:flex flex-col w-[256px] shrink-0 border-r transition-colors duration-250 ${
          isDark
      ...
      >
        ...
        {/* Bottom Section */}
        <div
          className={`px-3 pb-4 pt-3 space-y-0.5 border-t transition-colors ${
        ...
        >
          ...
          {user ? (
            ...
            <Link to="/auth" className={`${navItemBase} ${navItemInactive}`}>
      ...
      <div className="flex-1 flex flex-col min-w-0 pb-20 md:pb-0">
        {/* Top Header */}
        <header
          className={`flex items-center justify-between px-5 md:px-8 h-[60px] shrink-0 border-b transition-colors duration-250 ${
            isDark
              ? "bg-[#0c0c0e]/80 border-zinc-800/50 backdrop-blur-xl"
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              >
                voici l'avancement de tes révisions
              </span>
            </p>
          </div>
          ...
          <div className="flex items-center gap-1.5">
            ...
            >
              {isSyncing ? (
                ...
                <CloudOff
                  className={`w-4 h-4 ${isDark ? "text-zinc-600" : "text-slate-400"}`}
                />
              ) : (
      ...
      {/* ===== MOBILE BOTTOM NAV ===== */}
      <nav
        className={`md:hidden fixed bottom-0 left-0 right-0 backdrop-blur-xl border-t px-2 py-1.5 flex justify-around items-center z-50 transition-colors duration-250 ${
          isDark
            ? "bg-[#0c0c0e]/90 border-zinc-800/50"
      ...
      >
        {allMenuItems.map((item) => {
          ...
          return (
            ...
            >
              <Icon
                className={`w-5 h-5 ${isActive ? "animate-count-up" : ""}`}
              />
